...
define('ember-quickstart/routes/programmers', ['exports', 'ember'], function (exports, _ember) {
  exports['default'] = _ember['default'].Route.extend({
    model: function model() {
      return ['Tim Berners Lee', 'Bill Gates', 'Steve Wozniak'];
    }
  });
});
...
define("ember-quickstart/templates/programmers", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template((function () {
    return {
      ...
      statements: [["inline", "people-list", [], ["title", "List of Programmers", "people", ["subexpr", "@mut", [["get", "model", ["loc", [null, [1, 49], [1, 54]]], 0, 0, 0, 0]], [], [], 0, 0]], ["loc", [null, [1, 0], [1, 56]]], 0, 0]],
      locals: [],
      templates: []
    };
  })());
...
if (!runningTests) {
  require("ember-quickstart/app")["default"].create({"name":"ember-quickstart","version":"0.0.0+bef83fda"});
}
